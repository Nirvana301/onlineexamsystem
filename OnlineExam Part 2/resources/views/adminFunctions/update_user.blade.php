...
<html>
    ...
    <form action = "/homepage_admin/edit_user/<?php echo $users[0]->id; ?>" method = "post">
            ...
            <div class="container3 register-form">
                <div class="form">
                        <h2 style="text-align:center; margin-top:130px;"><b>Edit User</b></h2>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="id" type="text" class="form-control input-md" value = '<?php echo$users[0]->id; ?>' required="" readonly>
                                </div>
