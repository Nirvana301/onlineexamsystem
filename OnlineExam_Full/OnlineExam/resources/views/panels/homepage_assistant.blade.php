...
<div id="navbar" class="w3-container">
    ...
    <div id="panel" class="w3-bar w3-blue">
        <a href="{{ url('/homepage_assistant') }}" class="w3-bar-item w3-button w3-mobile">Courses</a>
    ...
    <div id="genel">
        <div id="courses">
            @foreach ($courses as $course)
                        <div id="course">
                            <b><a href="/assistant_courses/{{$course->id}}">{{ $course->course_name }} </a></b>
                            <a href = "/assistant_courses/{{$course->id}}" target = "_self"> 
