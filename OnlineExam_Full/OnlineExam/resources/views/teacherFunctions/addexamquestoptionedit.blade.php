...
<head>
    ...
    <title>O-Exam | Edit Question Option</title>
...
<nav class="navbar header-top fixed-top navbar-expand-lg" style="margin-top: 130px;">
    ...
    <li class="nav-item">
        ...
        <br><br>
        <a class="personalInfoLink" onclick="goBack();"
    ...
    <div class="container3 register-form" style="margin-top: 112px">
        <div class="form">
            <div class="form-content" style="background-color: white; width:800px">
                <h2 style="text-align:center;"><b>Edit Question Option</b></h2><br>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group" id="op1" >
                            <label class="col-md-6 control-label" style="margin-left: 138px">Option Value</label>
                            <input name="value" id = "option1" type="text" style="width:125%; margin-left:138px;" class="form-control input-md" value='<?php echo$multiplechoiceanswer[0]->value; ?>'required="">
                        </div>

                        <div class="form-group" id="op1" >
                            <label class="col-md-6 control-label" style="margin-left: 138px">Option Answer</label>
                            <input name="answer" id = "option1" type="text" style="width: 125%; margin-left:138px;" class="form-control input-md" value='<?php echo$multiplechoiceanswer[0]->answer; ?>'required="">
                        </div>
                        

                        <h3 style="color:#0750a3; margin-left:138px;">Correct Answer:</h3>
                        <h3 style="color:#0750a3; margin-left:138px;">{{ $question->correct_answer }}</h3>
