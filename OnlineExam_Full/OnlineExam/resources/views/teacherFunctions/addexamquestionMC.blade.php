    ...
    <nav class="navbar header-top fixed-top navbar-expand-lg" style="margin-top: 130px;">
        ...
        <li class="nav-item">
            ...
            <div class="container3 register-form" style="margin-top: 75px">
                <div class="form">
                    <div class="form-content" style="background-color: white; width: 800px; margin-top:100px">
                        ...
                        <div class="row" style="width: 900px">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group" id ="ca">
                                    <label style="margin-left: 150px" class="col-md-6 control-label">Correct Answer:</label>
                                    <input style="margin-left: 150px" name="correct_answer" id="correctanswer" type="text" class="form-control input-md" required="">
                                </div>

                                <div class="form-group">
                                    <label style="margin-left: 150px" class="col-md-6 control-label">Question Point:</label>
                                    <input style="margin-left: 150px" name="evaluation_grade" id="evaluation_grade" type="number" class="form-control input-md" required="" min="1">
                                </div>
